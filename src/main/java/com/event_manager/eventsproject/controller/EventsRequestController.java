...
/**
 * Controller class for handling operations related to event requests.
 */
@CrossOrigin
@RestController
public class EventsRequestController {
    ...
    /**
     * Constructor to initialize EventsRequestController with EventsService dependency injection.
    ...
    /**
     * Retrieves all event requests associated with a specific user.
     * @param user_id The ID of the user to retrieve event requests for.
     * @return ResponseEntity containing a list of EventsRequestDto objects representing event requests.
     *         Returns 404 NOT FOUND if no requests are found for the user.
     */
    ...
    /**
     * Saves a new event request.
     * @param body The EventsRequest object containing details of the request to be saved.
     * @return ResponseEntity containing the saved EventsRequest object if successful, or 400 BAD REQUEST if the request already exists.
     *         Returns 500 INTERNAL SERVER ERROR if there's an unexpected issue during saving.
     */
    ...
    /**
     * Updates the status of an existing event request by ID.
     * @param id The ID of the event request to update.
     * @param body The EventsRequest object containing the updated status.
     * @return ResponseEntity containing the updated EventsRequest object if successful, or 404 NOT FOUND if no request with the given ID is found.
     */
    ...
    /**
     * Deletes an event request by ID.
     * @param id The ID of the event request to delete.
     * @return ResponseEntity indicating success or failure of the delete operation.
     *         Returns 404 NOT FOUND if no request with the given ID is found.
     */
